...
- Name: workflow1-effet-academique.spec.ts >> Workflow 1 — Effet Académique (end-to-end) >> Step 6: Scolarité exécute then clôture the request
- Location: e2e\workflow1-effet-academique.spec.ts:86:7
