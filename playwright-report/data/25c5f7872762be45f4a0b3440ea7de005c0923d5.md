...
- Name: workflow2-correction-nom.spec.ts >> Workflow 2 — Correction de Nom (avec rejet) >> Step 2: Secretariat réceptionne the Correction de Nom request
- Location: e2e\workflow2-correction-nom.spec.ts:42:7
